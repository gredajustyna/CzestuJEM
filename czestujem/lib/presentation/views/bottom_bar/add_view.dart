        ...
        child: Column(
          ...
          children: [
            ...
            RawMaterialButton(
              onPressed: () async{
                var uuid = Uuid();
                await FireBase.addFood(fileName, imageFile, new Food('', 'pizzka', 'dobra pizzka fajm', GeoPoint(globals.location.latitude, globals.location.longitude), 'food', DateTime.now(), FirebaseAuth.instance.currentUser!.uid, uuid.v1()));
                    ...
                    if(_descriptionController.text.isNotEmpty){
                      ...
                      if(isImageInitialized){
                        Food food = Food('1', _titleController.text,
                            ...
                            date, FirebaseAuth.instance.currentUser!.uid, uuid.v1());
                      ...
                      showSnackBar('Dodaj opis do jedzenia!');
                    }
                  }else{
                    showSnackBar('Nadaj nazwę swojej potrawie!');
                  }
                },
                child: Text(
                  'Dodaj!',
